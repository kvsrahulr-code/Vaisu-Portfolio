...
export const PROJECTS: Project[] = [
  {
    ...
    concept: 'The concept centered around "Filtered Light" – using intricate mashrabiya patterns to create dynamic shadows while maintaining privacy in a high-end residential setting in Kuwait City.',
    gallery: [
  ...
  },
  {
    ...
    concept: 'Biophilic integration within a corporate environment. We utilized vertical gardens and natural timber finishes to contrast the glass and steel of the Singapore skyline.',
    gallery: [
  ...
  },
  {
    ...
    concept: 'The Monolith explores the relationship between heavy concrete forms and light, airy interiors. Large floor-to-ceiling windows dissolve the boundary between inside and out.',
    gallery: [
...
export const EXPERTISE: Expertise[] = [
  {
    ...
    expandedDescription: 'We believe every space has a story to tell. By carefully curating the sequence of experiences, we create environments that resonate emotionally with their occupants.',
    previews: [
  ...
  },
  {
    ...
    expandedDescription: 'Our process begins with deep research and creative exploration. We develop unique design languages that translate abstract ideas into tangible architectural forms.',
    previews: [
  ...
  },
  {
    ...
    expandedDescription: 'Precision in layout is the foundation of good design. We analyze human movement and interaction to create highly efficient yet beautiful spatial configurations.',
    previews: [
  ...
  },
  {
    ...
    expandedDescription: 'Bridging the gap between imagination and reality. Our visualizations provide absolute clarity, allowing clients to experience their future spaces in stunning detail.',
    previews: [
  ...
  },
  {
    ...
    expandedDescription: 'We focus on the subtle nuances—the play of light on a surface, the grain of wood, the softness of fabric—to create imagery that is indistinguishable from photography.',
    previews: [
